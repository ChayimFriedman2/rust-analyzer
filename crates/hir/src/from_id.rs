...
impl From<ItemInNsId> for ItemInNs<'_> {
    fn from(value: ItemInNsId) -> Self {
        match value {
            ItemInNsId::Types(value) => ItemInNs::Types(value.into()),
            ItemInNsId::Values(value) => ItemInNs::Values(value.into()),
            ItemInNsId::Macros(value) => ItemInNs::Macros(value.into()),
        }
    }
}
