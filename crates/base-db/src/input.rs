...
pub type BuiltProcMacroPaths = FxHashMap<CrateId, Result<(String, AbsPathBuf), String>>;
...
pub struct UniqueCrateData {
    root_file_id: FileId,
    disambiguator: Option<Arc<CrateData>>,
}
...
impl CrateGraphBuilder {
    ...
    pub fn set_in_db(self, db: &mut dyn SourceRootDatabase) -> CratesIdMap {
        ...
        fn go(
            ...
            let mut dependencies = graph.arena[source]
                .basic
                .dependencies
                .iter()
                .map(|dep| Dependency {
                ...
                .collect::<Vec<_>>();
            // Improve sharing of crate IDs by sorting dependencies.
            dependencies.sort_unstable_by_key(|dep| dep.crate_id);
