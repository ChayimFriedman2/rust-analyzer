...
use ide_db::base_db::{BuiltProcMacroPaths, CrateId, SourceDatabase, SourceRootDatabase};
...
pub(crate) struct GlobalState {
    ...
    pub(crate) fetch_proc_macros_queue: OpQueue<Vec<BuiltProcMacroPaths>, bool>,
