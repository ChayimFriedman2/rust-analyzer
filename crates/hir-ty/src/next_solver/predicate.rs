...
use rustc_type_ir::{
    self as ty, CollectAndApply, CustomizableTypeVisitable, EarlyBinder, FlagComputation, Flags,
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, CustomizableTypeVisitable)]
...
impl<'db, V: super::WorldExposer> rustc_type_ir::CustomizableTypeVisitable<V> for Clauses<'db> {
...
#[derive(Copy, Clone, PartialEq, Eq, Hash, Debug, CustomizableTypeVisitable)] // TODO implement Debug by hand
...
impl<'db, V: super::WorldExposer> CustomizableTypeVisitable<V> for Predicate<'db> {
    fn customizable_visit_with(&self, visitor: &mut V) {
