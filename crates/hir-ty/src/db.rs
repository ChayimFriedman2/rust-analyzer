...
pub trait HirDatabase: DefDatabase + Upcast<dyn DefDatabase> + std::fmt::Debug {
    ...
    #[db_ext_macro::invoke_actual(crate::layout::target_data_layout_query)]
    ...
    #[db_ext_macro::invoke_actual(InherentImpls::inherent_impls_in_crate_query)]
    ...
    #[db_ext_macro::invoke_actual(TraitImpls::trait_impls_in_crate_query)]
    ...
    #[db_ext_macro::invoke_actual(TraitImpls::trait_impls_in_deps_query)]
