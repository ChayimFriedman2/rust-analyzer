    ...
    + Upcast<dyn RootQueryDb>
{
    ...
    #[db_ext_macro::invoke_actual(DefMap::crate_local_def_map_query)]
    fn crate_local_def_map(&self, krate: Crate) -> (Arc<DefMap>, Arc<LocalDefMap>);

    #[db_ext_macro::invoke_actual(DefMap::crate_def_map_query)]
    ...
    #[db_ext_macro::invoke_actual(ImportMap::import_map_query)]
    ...
    #[db_ext_macro::invoke_actual(LangItems::crate_lang_items_query)]
    fn crate_lang_items(&self, krate: Crate) -> Option<Arc<LangItems>>;

    #[db_ext_macro::invoke_actual(crate::lang_item::notable_traits_in_deps)]
    fn notable_traits_in_deps(&self, krate: Crate) -> Arc<[Arc<[TraitId]>]>;
    #[db_ext_macro::invoke_actual(crate::lang_item::crate_notable_traits)]
    fn crate_notable_traits(&self, krate: Crate) -> Option<Arc<[TraitId]>>;

    #[db_ext_macro::invoke_actual(crate_supports_no_std)]
    fn crate_supports_no_std(&self, crate_id: Crate) -> bool;

    #[db_ext_macro::invoke_actual(include_macro_invoc)]
